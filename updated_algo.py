...
def probability(UCQ):
    ...
    if (len(UCQ) == 1 and len(UCQ[0])>1 and check_Independence_CQ(UCQ[0])):
        print("CASE4")
        Pr = 0.0
...
#UCQ,quantifier = convert_to_universal(UCQ,quantifier)
domain = get_domain(probabilities)
#print("domain",domain)
temp = [{'R': {'var': [0,0], 'negation': False, 'const': False}}]
